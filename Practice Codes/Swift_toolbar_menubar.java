...
{ 
    ...
    MyFrame()
    {
       ...
       b1=new JButton(new ImageIcon("E:\\Downloads\\toolbar.png"));
       b2=new JButton(new ImageIcon("E:\\Downloads\\toolbar2.png"));
       b3=new JButton(new ImageIcon("E:\\Downloads\\toolbar.png"));
       b4=new JButton(new ImageIcon("E:\\Downloads\\toolbar2.png"));
       b5=new JButton(new ImageIcon("E:\\Downloads\\toolbar.png"));
       b6=new JButton(new ImageIcon("E:\\Downloads\\toolbar2.png"));
       b7=new JButton(new ImageIcon("E:\\Downloads\\toolbar.png"));
...
public class Swift_toolbar_menubar {
